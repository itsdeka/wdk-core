...
export interface USDVMainInterface extends utils.Interface {
  functions: {
...
export interface RemintedEventObject {
  deltas: DeltaStructOutput[];
  remintFee: BigNumber;
}
export type RemintedEvent = TypedEvent<
  [DeltaStructOutput[], BigNumber],
  RemintedEventObject
>;

export type RemintedEventFilter = TypedEventFilter<RemintedEvent>;
...
export interface USDVMain extends BaseContract {
