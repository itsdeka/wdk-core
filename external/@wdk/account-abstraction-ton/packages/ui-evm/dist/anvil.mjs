...
import { waitFor, assert } from '@layerzerolabs/ui-core';
...
var { Interface, solidityKeccak256, getAddress, hexZeroPad, hexlify } = utils;
...
// src/anvil.ts
var AnvilProvider = class extends JsonRpcProvider {
  constructor(fork) {
    super(fork.forkUrl);
    this.fork = fork;
  }
  ...
  getErc20Balance(contract, wallet) {
    const erc20 = new ethers.Contract(contract, ERC20_default, this);
