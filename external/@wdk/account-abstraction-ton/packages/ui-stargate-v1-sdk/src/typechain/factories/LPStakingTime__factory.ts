...
export class LPStakingTime__factory {
  static readonly abi = _abi;
  static createInterface(): LPStakingTimeInterface {
    return new utils.Interface(_abi) as LPStakingTimeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LPStakingTime {
    return new Contract(address, _abi, signerOrProvider) as LPStakingTime;
  }
}
