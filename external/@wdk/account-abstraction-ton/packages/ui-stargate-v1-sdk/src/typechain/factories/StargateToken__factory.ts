...
export class StargateToken__factory {
  static readonly abi = _abi;
  static createInterface(): StargateTokenInterface {
    return new utils.Interface(_abi) as StargateTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StargateToken {
    return new Contract(address, _abi, signerOrProvider) as StargateToken;
  }
}
