...
import type {
  WhitelistAuction,
  WhitelistAuctionInterface,
} from "../WhitelistAuction";
...
export class WhitelistAuction__factory {
  static readonly abi = _abi;
  static createInterface(): WhitelistAuctionInterface {
    return new utils.Interface(_abi) as WhitelistAuctionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WhitelistAuction {
    return new Contract(address, _abi, signerOrProvider) as WhitelistAuction;
  }
}
