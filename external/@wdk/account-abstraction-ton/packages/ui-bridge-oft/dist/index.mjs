export { createOftBridgeConfig, oftBridgeConfigSchema, serializeOftBridgeConfig } from './chunk-RKJNJO2U.mjs';
import { OftBridgeBase } from './chunk-6FNBPY3S.mjs';
export { OftBridgeApiFactory__evm, OftBridgeV0, OftBridgeV1, OftBridgeV2, OftBridgeV2Fee, OftBridgeV3, OftBridgeBase as OftBridge__evm } from './chunk-6FNBPY3S.mjs';
import { addressToBytes32ForChain, createOptions } from './chunk-DHS2PT7H.mjs';
export { addressToBytes32ForChain, createOptions, getDeployment, tryGetDeployment } from './chunk-DHS2PT7H.mjs';
import { toTronAddress } from './chunk-V5ZIFKDM.mjs';
export { fromTronAddress, toTronAddress } from './chunk-V5ZIFKDM.mjs';
import './chunk-EJHQDNHP.mjs';
import { endpointIdToChainKey, endpointIdToStage, chainKeyToEndpointId, getNativeCurrency, assert, isTronChainKey, CurrencyAmount, parseCurrencyAmount, MessageFee, castCurrencyAmountUnsafe } from '@layerzerolabs/ui-core';
...
function convertFromV1(oldOftBridgeConfig, endpointVersion) {
  ...
  for (const chainId of chainIds) {
    ...
    const token = oldOftBridgeConfig.tokens.find((token2) => token2.chainId === chainId) ?? (native ? getNativeCurrency(chainKey) : void 0);
...
var OftBridgeV3__tron = class extends OftBridgeBase {
  ...
  supportsTransfer(srcToken, dstToken) {
    if (!isTronChainKey(srcToken.chainKey))
      return false;
  ...
  async getMessageFee(input) {
    ...
    try {
      ...
      const native = getNativeCurrency(srcChainKey);
      return {
        nativeFee: CurrencyAmount.fromRawAmount(native, BigInt(5e6)),
        // 5 TRX
  ...
  async buildSendParams(input) {
    ...
    const minAmount = input.dstAmountMin ? castCurrencyAmountUnsafe(input.dstAmountMin, srcAmount.token) : CurrencyAmount.fromRawAmount(srcAmount.token, srcAmount.toBigInt() / 2n);
...
export { OftBridgeApiFactory__tron, OftBridgeV3__tron, convertFromV1 };
