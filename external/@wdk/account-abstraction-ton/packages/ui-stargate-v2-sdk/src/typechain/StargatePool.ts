...
export interface StargatePoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "burnAllowanceSD",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "burnLockedUSDC",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type AddressConfigSetEvent = TypedEvent<
  [StargateBase.AddressConfigStructOutput],
  AddressConfigSetEventObject
>;

export type AddressConfigSetEventFilter =
  TypedEventFilter<AddressConfigSetEvent>;
...
export type OFTPathSetEvent = TypedEvent<
  [number, boolean],
...
export type Path_CreditBurnedEvent = TypedEvent<
  [BigNumber],
  Path_CreditBurnedEventObject
>;

export type Path_CreditBurnedEventFilter =
  TypedEventFilter<Path_CreditBurnedEvent>;
...
export type PlannerFeeWithdrawnEvent = TypedEvent<
  [BigNumber],
  PlannerFeeWithdrawnEventObject
>;

export type PlannerFeeWithdrawnEventFilter =
  TypedEventFilter<PlannerFeeWithdrawnEvent>;
...
export type TreasuryFeeAddedEvent = TypedEvent<
  [BigNumber],
  TreasuryFeeAddedEventObject
>;

export type TreasuryFeeAddedEventFilter =
  TypedEventFilter<TreasuryFeeAddedEvent>;

export interface TreasuryFeeWithdrawnEventObject {
  to: string;
  amountSD: BigNumber;
}
export type TreasuryFeeWithdrawnEvent = TypedEvent<
  [string, BigNumber],
  TreasuryFeeWithdrawnEventObject
>;

export type TreasuryFeeWithdrawnEventFilter =
  TypedEventFilter<TreasuryFeeWithdrawnEvent>;
...
export type UnreceivedTokenCachedEventFilter =
  TypedEventFilter<UnreceivedTokenCachedEvent>;
...
export interface StargatePool extends BaseContract {
  ...
  functions: {
    ...
    allowBurn(
      _burnAdmin: PromiseOrValue<string>,
      _burnAllowanceSD: PromiseOrValue<BigNumberish>,
    ...
    ): Promise<[StargateBase.AddressConfigStructOutput]>;
  ...
  filters: {
    ...
    "PlannerFeeWithdrawn(uint256)"(
      amount?: null
    ): PlannerFeeWithdrawnEventFilter;
    ...
    "TreasuryFeeWithdrawn(address,uint64)"(
      to?: null,
      amountSD?: null
    ): TreasuryFeeWithdrawnEventFilter;
