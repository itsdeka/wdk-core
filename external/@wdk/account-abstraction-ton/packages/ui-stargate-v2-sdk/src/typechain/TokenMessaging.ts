...
export interface TokenMessagingInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [TaxiParamsStruct, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
...
export type AssetIdSetEvent = TypedEvent<
  [string, number],
...
export type BusDrivenEvent = TypedEvent<
...
export type BusQueueStorageInitializedEventFilter =
  TypedEventFilter<BusQueueStorageInitializedEvent>;
...
export type BusRodeEvent = TypedEvent<
...
export type FaresSetEvent = TypedEvent<
...
export type GasLimitSetEvent = TypedEvent<
  [number, BigNumber, BigNumber],
...
export type MaxNumPassengersSetEvent = TypedEvent<
  [number, number],
  MaxNumPassengersSetEventObject
>;

export type MaxNumPassengersSetEventFilter =
  TypedEventFilter<MaxNumPassengersSetEvent>;

export interface NativeDropAmountSetEventObject {
  dstEid: number;
  nativeDropAmount: BigNumber;
}
export type NativeDropAmountSetEvent = TypedEvent<
  [number, BigNumber],
  NativeDropAmountSetEventObject
>;

export type NativeDropAmountSetEventFilter =
  TypedEventFilter<NativeDropAmountSetEvent>;
...
export type NativeDropFailedEvent = TypedEvent<
  [string, BigNumber],
  NativeDropFailedEventObject
>;

export type NativeDropFailedEventFilter =
  TypedEventFilter<NativeDropFailedEvent>;
...
export interface TokenMessaging extends BaseContract {
  ...
  filters: {
    "AssetIdSet(address,uint16)"(
      stargateImpl?: null,
      assetId?: null
    ): AssetIdSetEventFilter;
    ...
    "MaxNumPassengersSet(uint32,uint8)"(
      dstEid?: null,
      maxNumPassengers?: null
    ): MaxNumPassengersSetEventFilter;
    MaxNumPassengersSet(
      dstEid?: null,
      maxNumPassengers?: null
    ): MaxNumPassengersSetEventFilter;

    "NativeDropAmountSet(uint32,uint128)"(
      dstEid?: null,
      nativeDropAmount?: null
    ): NativeDropAmountSetEventFilter;
    NativeDropAmountSet(
      dstEid?: null,
      nativeDropAmount?: null
    ): NativeDropAmountSetEventFilter;

    "NativeDropApplied(address,uint128)"(
      receiver?: null,
      amount?: null
    ...
    "NativeDropFailed(address,uint128)"(
      receiver?: null,
      amount?: null
    ): NativeDropFailedEventFilter;
    NativeDropFailed(
      receiver?: null,
      amount?: null
    ): NativeDropFailedEventFilter;
