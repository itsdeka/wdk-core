...
import type { FeeLibV1, FeeLibV1Interface } from "../FeeLibV1";
...
export class FeeLibV1__factory {
  static readonly abi = _abi;
  static createInterface(): FeeLibV1Interface {
    return new utils.Interface(_abi) as FeeLibV1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FeeLibV1 {
    return new Contract(address, _abi, signerOrProvider) as FeeLibV1;
  }
}
