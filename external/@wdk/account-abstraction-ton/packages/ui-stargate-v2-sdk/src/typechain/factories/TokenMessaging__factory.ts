...
export class TokenMessaging__factory {
  static readonly abi = _abi;
  static createInterface(): TokenMessagingInterface {
    return new utils.Interface(_abi) as TokenMessagingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TokenMessaging {
    return new Contract(address, _abi, signerOrProvider) as TokenMessaging;
  }
}
