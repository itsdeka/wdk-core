...
import { assert, isEvmChainKey, isToken, getMessageDuration, CurrencyAmount, castCurrencyAmountUnsafe, getNativeCurrency, removeDust, MaxUint256 } from '@layerzerolabs/ui-core';
import { ERC20__api, createTransaction, addressToBytes32, ONE_ADDRESS, serializeAdapterParams } from '@layerzerolabs/ui-evm';
...
var OftWrapperBridge__evm = class {
  ...
  supportsRegister(token) {
    if (!isEvmChainKey(token.chainKey))
      return false;
  ...
  buildLayerZeroCallParams(adapterParams, refundAddress, zroPaymentAddress = constants.AddressZero) {
    const callParams = {
...
export { OftWrapperBridge__evm, mainnet, serializedPartnerConfig, serializedWrapperConfig };
