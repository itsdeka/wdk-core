...
export interface OFTWrapperInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setDefaultBps",
...
export type WrapperFeeWithdrawnEvent = TypedEvent<
  [string, string, BigNumber],
  WrapperFeeWithdrawnEventObject
>;

export type WrapperFeeWithdrawnEventFilter =
  TypedEventFilter<WrapperFeeWithdrawnEvent>;
...
export type WrapperFeesEvent = TypedEvent<
