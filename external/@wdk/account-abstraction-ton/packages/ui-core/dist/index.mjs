import { networks, deployments, rpcs } from '@layerzerolabs/ui-config';
import z from 'zod';
...
var Price = class extends Fraction {
  ...
  quote(currencyAmount) {
    assert(currencyAmount.token.equals(this.baseCurrency), "TOKEN");
...
// src/currency/zod.ts
var serializedCoinSchema = z.object({
  name: z.string().optional(),
  symbol: z.string(),
  decimals: z.number(),
  chainKey: z.string()
});
var serializedTokenSchema = z.object({
  name: z.string().optional(),
  symbol: z.string(),
  decimals: z.number(),
  chainKey: z.string(),
...
var serializedCurrencySchema = z.union([
  // order matters
  serializedTokenSchema,
  serializedCoinSchema
]);
var serializedAmountSchema = z.object({
  // as bigint
  amount: z.string(),
...
// src/network/zod.ts
var serializedNetworkSchema = z.object({
  name: z.string(),
  shortName: z.string(),
  chainKey: z.string(),
