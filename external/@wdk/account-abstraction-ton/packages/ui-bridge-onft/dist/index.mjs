import { isEvmChainKey, assert, getNativeCurrency, CurrencyAmount } from '@layerzerolabs/ui-core';
import { utils, Contract } from 'ethers';
import { createTransaction, serializeAdapterParams, ZERO_ADDRESS, ONE_ADDRESS } from '@layerzerolabs/ui-evm';
import z from 'zod';
...
var RPC__Enumerable__ERC721BalanceProvider = class {
  ...
  supports(collection) {
    if (collection.standard !== NftStandard.ERC721)
      return false;
    if (!isEvmChainKey(collection.chainKey))
      return false;
...
var onftBridgeConfigSchema = z.object({
  standard: nftStandardSchema,
  name: z.string(),
...
export { Amount, NftAsset, NftCollection, NftStandard, OnftBridgeApi__ERC1155__evm, OnftBridgeApi__ERC721__evm, RPC__ERC1155MetadataProvider, RPC__ERC721MetadataProvider, RPC__Enumerable__ERC721BalanceProvider, RPC__StaticId__ERC1155BalanceProvider, SimpleHash__MetadataProvider, Simplehash__BalanceProvider, createOnftBridgeConfig, nftAssetSchema, nftCollectionSchema, nftStandardSchema, onftBridgeConfigSchema, serializeOnftBridgeConfig };
